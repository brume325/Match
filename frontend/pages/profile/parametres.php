...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'modifier') {
    ...
    if ($remove_avatar) {
        if (!empty($avatar) && str_starts_with($avatar, 'uploads/avatars/')) {
            $old_avatar_path = __DIR__ . '/' . $avatar;
            ...
            if ($tmp_name === '' || !is_uploaded_file($tmp_name)) {
                ...
                if (!isset($allowed_mimes[$mime])) {
                    ...
                    if (!is_dir($upload_dir) && !mkdir($upload_dir, 0755, true)) {
                        ...
                        if (!move_uploaded_file($tmp_name, __DIR__ . '/' . $file_name)) {
...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="css/style_parametres.css">
  </head>
  <body>
        ...
        <section class="settings-wrapper">
          ...
          <section class="settings-card">
            ...
            <form method="POST" action="parametres.php">
              ...
              <div style="display:flex; align-items:center; gap:16px; padding:16px; background:var(--mm-bg); border-radius:10px;">
                <div style="flex:1;">
                  <strong><?= $twofa ? '✅ Activée' : '❌ Désactivée' ?></strong>
            ...
            <p style="font-size:.78rem; color:var(--mm-grey); margin-top:10px;">
              ⚠️ Nécessite un serveur mail configuré pour l'envoi des codes.
          ...
          <section class="settings-card">
            ...
            <div style="display:flex; gap:12px; flex-wrap:wrap;">
              <a href="export_rgpd.php" class="btn btn-outline btn-sm">📥 Exporter mes données</a>
              <a href="confidentialite.php" class="btn btn-outline btn-sm">🔒 Politique de confidentialité</a>
            </div>
          </section>
